namespace TonLibDotNet.Data
{
    public class BocTests
    {
        ...
        {
            /*
             * Sample from https://tonscan.org/address/EQAiIsvar4OYBn8BGBf9flfin6tl5poBx4MgJe4CQJYasy51#source
             *   for Contract Type: Domain toncenter.ton
             * Data are actual to moment of writing this test, 09 April 2023
             */
            var rawDataBase64 = @"
...
ofsUnfYHN48ButXpQ+GIQehKw1zgu7SH/QBABGrQHLR5Y1aO0b/jhc26yyJoLswQxV1mh0FgYAjq2Dl5VRoQBD2Qwk";
            /*
             * Same "Raw data" but as cells (decoded by tonscan.org):
            ...
            Assert.True(Boc.TryParseFromBase64(rawDataBase64, out var boc));
            Assert.NotNull(boc);
...
ofsUnfYHN48ButXpQ+GIQehKw1zgu7SH/QBABGrQHLR5Y1aO0b/jhc26yyJoLswQxV1mh0FgYAjq2Dl5VRoQBD2Qwk";
            ...
            Assert.NotNull(ms);
            Assert.Equal(Convert.ToHexString(Convert.FromBase64String(rawDataBase64)), Convert.ToHexString(ms.ToArray()));
        }
    }
}
